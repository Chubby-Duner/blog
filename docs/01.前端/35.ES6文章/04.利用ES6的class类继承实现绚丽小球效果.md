...
**效果图示**
![ball-normal](https://cdn.jsdelivr.net/gh/zchaoGe/image-hosting@master/ES6/ball-normal.gif)
## 实现步骤
- 书写HTML
- 创建canvas画布环境
- 书写小球类Ball
...
![ball](https://cdn.jsdelivr.net/gh/zchaoGe/image-hosting@master/ES6/ball.gif)
